...
import { JLPTTrapDrillModal } from '@/components/practice/JLPTTrapDrillModal'
...
export default function PracticePage() {
  ...
  const [activeDrillModal, setActiveDrillModal] = useState<'particle' | 'order' | 'sprint' | 'trap' | null>(null)
    ...
    <div className="space-y-7 animate-fade-in pb-12">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* 1. JLPT Trap Master Drill */}
          <div className="bg-surface rounded-2xl border-2 border-amber-500/30 p-5 shadow-card hover:shadow-card-hover hover:border-amber-500 transition-all flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-2 right-2 text-[10px] px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 font-bold border border-amber-500/20 font-mono">
              JLPT Traps
            </div>
            <div>
              ...
              <h4 className="text-base font-bold text-text-primary group-hover:text-amber-500 transition-colors">
                JLPT Trap Master Drill
              </h4>
              <p className="text-[11px] text-text-tertiary font-japanese font-medium mb-2">JLPT トラップ特訓 (全分野)</p>
              <p className="text-xs text-text-secondary leading-relaxed mb-4">
                Conquer tricky deceptive options across Kanji lookalikes, Verb sound shifts, Body parts, Numbers, Clock, and more.
              </p>
            </div>
            <button
              onClick={() => setActiveDrillModal('trap')}
              className="w-full py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 active:scale-98 cursor-pointer"
            >
              <Play size={13} fill="currentColor" />
              <span>Start JLPT Trap Drill</span>
            </button>
          </div>

          {/* 2. Particle Master */}
          <div className="bg-surface rounded-2xl border border-border p-5 shadow-card hover:shadow-card-hover hover:border-accent/40 transition-all flex flex-col justify-between group">
            <div>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-accent hover:bg-accent/90 text-white text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 active:scale-98 cursor-pointer"
            >
              <Play size={13} fill="currentColor" />
          ...
          <div className="bg-surface rounded-2xl border border-border p-5 shadow-card hover:shadow-card-hover hover:border-indigo-500/40 transition-all flex flex-col justify-between group">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 active:scale-98 cursor-pointer"
            >
              <Play size={13} fill="currentColor" />
          ...
          {/* 4. Quick-Fire 10-Question Sprint */}
          <div className="bg-surface rounded-2xl border border-border p-5 shadow-card hover:shadow-card-hover hover:border-rose-500/40 transition-all flex flex-col justify-between group">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-rose-500 hover:bg-rose-600 text-white text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 active:scale-98 cursor-pointer"
            >
              <Play size={13} fill="currentColor" />
      ...
      {/* Modals */}
      {activeDrillModal === 'trap' && (
        <JLPTTrapDrillModal onClose={() => setActiveDrillModal(null)} />
      )}
