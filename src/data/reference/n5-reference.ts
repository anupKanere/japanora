...
export const n5Adjectives: Adjective[] = [
  ...
  { type: 'i', hiragana: 'あつい', kanji: '熱い / 暑い', romaji: 'atsui', meaning: 'hot (temperature/weather)', conjugation: { negative: 'あつくない', past: 'あつかった', negativePast: 'あつくなかった' } },
  ...
  { type: 'i', hiragana: 'やさしい', kanji: '易しい', romaji: 'yasashii', meaning: 'easy (task)', conjugation: { negative: 'やさしくない', past: 'やさしかった', negativePast: 'やさしくなかった' } },
  ...
  { type: 'i', hiragana: 'にぎやかい', kanji: '賑やか', romaji: 'nigiyakai', meaning: 'lively / busy', conjugation: { negative: 'にぎやかくない', past: 'にぎやかかった', negativePast: 'にぎやかくなかった' } },
  ...
  { type: 'i', hiragana: 'ひまな', kanji: '暇な', romaji: 'hima', meaning: 'free / not busy', conjugation: { negative: 'ひまではない', past: 'ひまだった', negativePast: 'ひまではなかった' } },
  ...
  { type: 'i', hiragana: 'たいへんな', kanji: '大変な', romaji: 'taihen', meaning: 'tough / terrible / awful', conjugation: { negative: 'たいへんではない', past: 'たいへんだった', negativePast: 'たいへんではなかった' } },
  ...
  { type: 'i', hiragana: 'うすい', kanji: '薄い', romaji: 'usui', meaning: 'thin / light (color/flavor)', conjugation: { negative: 'うすくない', past: 'うすかった', negativePast: 'うすくなかった' } },
  ...
  { type: 'i', hiragana: 'しずかな', kanji: '静かな', romaji: 'shizuka', meaning: 'quiet / peaceful', conjugation: { negative: 'しずかではない', past: 'しずかだった', negativePast: 'しずかではなかった' } },
  ...
  { type: 'na', hiragana: 'しずかな', kanji: '静かな', romaji: 'shizuka', meaning: 'quiet / peaceful', conjugation: { negative: 'しずかではない', past: 'しずかだった', negativePast: 'しずかではなかった' } },
...
export const n5VerbChart: VerbConjugation[] = [
  ...
  { id: 'v-001', dictionary: 'いく', kanji: '行く', meaning: 'to go', group: 'group1', masu: 'いきます', te: 'いって', ta: 'いった', nai: 'いかない', nakatta: 'いかなかった', note: 'く→って (special)' },
  { id: 'v-002', dictionary: 'くる', kanji: '来る', meaning: 'to come', group: 'irregular', masu: 'きます', te: 'きて', ta: 'きた', nai: 'こない', nakatta: 'こなかった' },
  { id: 'v-003', dictionary: 'かく', kanji: '書く', meaning: 'to write', group: 'group1', masu: 'かきます', te: 'かいて', ta: 'かいた', nai: 'かかない', nakatta: 'かかなかった' },
  { id: 'v-004', dictionary: 'きく', kanji: '聞く', meaning: 'to listen / to ask', group: 'group1', masu: 'ききます', te: 'きいて', ta: 'きいた', nai: 'きかない', nakatta: 'きかなかった' },
  { id: 'v-005', dictionary: 'はなす', kanji: '話す', meaning: 'to speak', group: 'group1', masu: 'はなします', te: 'はなして', ta: 'はなした', nai: 'はなさない', nakatta: 'はなさなかった' },
  { id: 'v-006', dictionary: 'よむ', kanji: '読む', meaning: 'to read', group: 'group1', masu: 'よみます', te: 'よんで', ta: 'よんだ', nai: 'よまない', nakatta: 'よまなかった' },
  { id: 'v-007', dictionary: 'のむ', kanji: '飲む', meaning: 'to drink', group: 'group1', masu: 'のみます', te: 'のんで', ta: 'のんだ', nai: 'のまない', nakatta: 'のまなかった' },
  { id: 'v-008', dictionary: 'かう', kanji: '買う', meaning: 'to buy', group: 'group1', masu: 'かいます', te: 'かって', ta: 'かった', nai: 'かわない', nakatta: 'かわなかった' },
  { id: 'v-009', dictionary: 'まつ', kanji: '待つ', meaning: 'to wait', group: 'group1', masu: 'まちます', te: 'まって', ta: 'まった', nai: 'またない', nakatta: 'またなかった' },
  { id: 'v-010', dictionary: 'かえる', kanji: '帰る', meaning: 'to return home', group: 'group1', masu: 'かえります', te: 'かえって', ta: 'かえった', nai: 'かえらない', nakatta: 'かえらなかった', note: 'Group 1 — ends in る but 3-mora stem' },
  { id: 'v-011', dictionary: 'とる', kanji: '撮る / 取る', meaning: 'to take (photo) / to take', group: 'group1', masu: 'とります', te: 'とって', ta: 'とった', nai: 'とらない', nakatta: 'とらなかった' },
  { id: 'v-012', dictionary: 'わかる', kanji: '分かる', meaning: 'to understand', group: 'group1', masu: 'わかります', te: 'わかって', ta: 'わかった', nai: 'わからない', nakatta: 'わからなかった' },
  { id: 'v-013', dictionary: 'ある', meaning: 'to exist (inanimate)', group: 'group1', masu: 'あります', te: 'あって', ta: 'あった', nai: 'ない', nakatta: 'なかった', note: 'Negative: ない (not あらない)' },
  { id: 'v-014', dictionary: 'あそぶ', kanji: '遊ぶ', meaning: 'to play', group: 'group1', masu: 'あそびます', te: 'あそんで', ta: 'あそんだ', nai: 'あそばない', nakatta: 'あそばなかった' },
  { id: 'v-015', dictionary: 'しぬ', kanji: '死ぬ', meaning: 'to die', group: 'group1', masu: 'しにます', te: 'しんで', ta: 'しんだ', nai: 'しなない', nakatta: 'しななかった' },
  { id: 'v-016', dictionary: 'のる', kanji: '乗る', meaning: 'to ride / to board', group: 'group1', masu: 'のります', te: 'のって', ta: 'のった', nai: 'のらない', nakatta: 'のらなかった' },
  { id: 'v-017', dictionary: 'おきる', kanji: '起きる', meaning: 'to wake up', group: 'group2', masu: 'おきます', te: 'おきて', ta: 'おきた', nai: 'おきない', nakatta: 'おきなかった' },
  { id: 'v-018', dictionary: 'きる', kanji: '切る', meaning: 'to cut', group: 'group1', masu: 'きります', te: 'きって', ta: 'きった', nai: 'きらない', nakatta: 'きらなかった' },
  { id: 'v-019', dictionary: 'ぬぐ', kanji: '脱ぐ', meaning: 'to take off (clothes)', group: 'group1', masu: 'ぬぎます', te: 'ぬいで', ta: 'ぬいだ', nai: 'ぬがない', nakatta: 'ぬがなかった' },
  { id: 'v-020', dictionary: 'およぐ', kanji: '泳ぐ', meaning: 'to swim', group: 'group1', masu: 'およぎます', te: 'およいで', ta: 'およいだ', nai: 'およがない', nakatta: 'およがなかった' },
  { id: 'v-021', dictionary: 'あるく', kanji: '歩く', meaning: 'to walk', group: 'group1', masu: 'あるきます', te: 'あるいて', ta: 'あるいた', nai: 'あるかない', nakatta: 'あるかなかった' },
  { id: 'v-022', dictionary: 'はしる', kanji: '走る', meaning: 'to run', group: 'group1', masu: 'はしります', te: 'はしって', ta: 'はしった', nai: 'はしらない', nakatta: 'はしらなかった' },
  { id: 'v-023', dictionary: 'あらう', kanji: '洗う', meaning: 'to wash', group: 'group1', masu: 'あらいます', te: 'あらって', ta: 'あらった', nai: 'あらわない', nakatta: 'あらわなかった' },
  { id: 'v-024', dictionary: 'つかう', kanji: '使う', meaning: 'to use', group: 'group1', masu: 'つかいます', te: 'つかって', ta: 'つかった', nai: 'つかわない', nakatta: 'つかわなかった' },
  { id: 'v-025', dictionary: 'いう', kanji: '言う', meaning: 'to say', group: 'group1', masu: 'いいます', te: 'いって', ta: 'いった', nai: 'いわない', nakatta: 'いわなかった' },
  { id: 'v-026', dictionary: 'おもう', kanji: '思う', meaning: 'to think', group: 'group1', masu: 'おもいます', te: 'おもって', ta: 'おもった', nai: 'おもわない', nakatta: 'おもわなかった' },
  { id: 'v-027', dictionary: 'かかる', kanji: 'かかる', meaning: 'to take (time/cost)', group: 'group1', masu: 'かかります', te: 'かかって', ta: 'かかった', nai: 'かからない', nakatta: 'かからなかった' },
  { id: 'v-028', dictionary: 'はじまる', kanji: '始まる', meaning: 'to begin (intrans.)', group: 'group1', masu: 'はじまります', te: 'はじまって', ta: 'はじまった', nai: 'はじまらない', nakatta: 'はじまらなかった' },
  { id: 'v-029', dictionary: 'おわる', kanji: '終わる', meaning: 'to end (intrans.)', group: 'group1', masu: 'おわります', te: 'おわって', ta: 'おわった', nai: 'おわらない', nakatta: 'おわらなかった' },
  { id: 'v-030', dictionary: 'おくる', kanji: '送る', meaning: 'to send', group: 'group1', masu: 'おくります', te: 'おくって', ta: 'おくった', nai: 'おくらない', nakatta: 'おくらなかった' },

  // ── Group 2 (Ichidan / ru-verbs) ─────────────────────────────────
  { id: 'v-031', dictionary: 'たべる', kanji: '食べる', meaning: 'to eat', group: 'group2', masu: 'たべます', te: 'たべて', ta: 'たべた', nai: 'たべない', nakatta: 'たべなかった' },
  { id: 'v-032', dictionary: 'みる', kanji: '見る', meaning: 'to see / to watch', group: 'group2', masu: 'みます', te: 'みて', ta: 'みた', nai: 'みない', nakatta: 'みなかった' },
  { id: 'v-033', dictionary: 'ねる', kanji: '寝る', meaning: 'to sleep', group: 'group2', masu: 'ねます', te: 'ねて', ta: 'ねた', nai: 'ねない', nakatta: 'ねなかった' },
  { id: 'v-034', dictionary: 'いる', meaning: 'to exist (animate)', group: 'group2', masu: 'います', te: 'いて', ta: 'いた', nai: 'いない', nakatta: 'いなかった' },
  { id: 'v-035', dictionary: 'でる', kanji: '出る', meaning: 'to go out / to leave', group: 'group2', masu: 'でます', te: 'でて', ta: 'でた', nai: 'でない', nakatta: 'でなかった' },
  { id: 'v-036', dictionary: 'あける', kanji: '開ける', meaning: 'to open (trans.)', group: 'group2', masu: 'あけます', te: 'あけて', ta: 'あけた', nai: 'あけない', nakatta: 'あけなかった' },
  { id: 'v-037', dictionary: 'しめる', kanji: '閉める', meaning: 'to close (trans.)', group: 'group2', masu: 'しめます', te: 'しめて', ta: 'しめた', nai: 'しめない', nakatta: 'しめなかった' },
  { id: 'v-038', dictionary: 'おしえる', kanji: '教える', meaning: 'to teach / to tell', group: 'group2', masu: 'おしえます', te: 'おしえて', ta: 'おしえた', nai: 'おしえない', nakatta: 'おしえなかった' },
  { id: 'v-039', dictionary: 'かりる', kanji: '借りる', meaning: 'to borrow', group: 'group2', masu: 'かります', te: 'かりて', ta: 'かりた', nai: 'かりない', nakatta: 'かりなかった' },
  { id: 'v-040', dictionary: 'かける', kanji: 'かける', meaning: 'to hang / to make a call', group: 'group2', masu: 'かけます', te: 'かけて', ta: 'かけた', nai: 'かけない', nakatta: 'かけなかった' },
  { id: 'v-041', dictionary: 'きる', kanji: '着る', meaning: 'to wear (upper body)', group: 'group2', masu: 'きます', te: 'きて', ta: 'きた', nai: 'きない', nakatta: 'きなかった', note: 'Group 2 (different from 切る Group 1)' },
  { id: 'v-042', dictionary: 'みせる', kanji: '見せる', meaning: 'to show', group: 'group2', masu: 'みせます', te: 'みせて', ta: 'みせた', nai: 'みせない', nakatta: 'みせなかった' },
  { id: 'v-043', dictionary: 'つける', kanji: '付ける / 点ける', meaning: 'to turn on / to attach', group: 'group2', masu: 'つけます', te: 'つけて', ta: 'つけた', nai: 'つけない', nakatta: 'つけなかった' },
  { id: 'v-044', dictionary: 'けす', kanji: '消す', meaning: 'to turn off / to erase', group: 'group1', masu: 'けします', te: 'けして', ta: 'けした', nai: 'けさない', nakatta: 'けさなかった' },
  { id: 'v-045', dictionary: 'おきる', kanji: '起きる', meaning: 'to get up / to wake up', group: 'group2', masu: 'おきます', te: 'おきて', ta: 'おきた', nai: 'おきない', nakatta: 'おきなかった' },
  { id: 'v-046', dictionary: 'おりる', kanji: '降りる', meaning: 'to get off / to descend', group: 'group2', masu: 'おります', te: 'おりて', ta: 'おりた', nai: 'おりない', nakatta: 'おりなかった' },
  { id: 'v-047', dictionary: 'はじめる', kanji: '始める', meaning: 'to begin (trans.)', group: 'group2', masu: 'はじめます', te: 'はじめて', ta: 'はじめた', nai: 'はじめない', nakatta: 'はじめなかった' },
  { id: 'v-048', dictionary: 'こたえる', kanji: '答える', meaning: 'to answer', group: 'group2', masu: 'こたえます', te: 'こたえて', ta: 'こたえた', nai: 'こたえない', nakatta: 'こたえなかった' },
  { id: 'v-049', dictionary: 'おぼえる', kanji: '覚える', meaning: 'to memorize / to remember', group: 'group2', masu: 'おぼえます', te: 'おぼえて', ta: 'おぼえた', nai: 'おぼえない', nakatta: 'おぼえなかった' },
  { id: 'v-050', dictionary: 'わすれる', kanji: '忘れる', meaning: 'to forget', group: 'group2', masu: 'わすれます', te: 'わすれて', ta: 'わすれた', nai: 'わすれない', nakatta: 'わすれなかった' },

  // ── Irregular verbs ───────────────────────────────────────────────
  { id: 'v-051', dictionary: 'する', meaning: 'to do', group: 'irregular', masu: 'します', te: 'して', ta: 'した', nai: 'しない', nakatta: 'しなかった' },
  { id: 'v-052', dictionary: 'くる', kanji: '来る', meaning: 'to come', group: 'irregular', masu: 'きます', te: 'きて', ta: 'きた', nai: 'こない', nakatta: 'こなかった' },
  { id: 'v-053', dictionary: 'べんきょうする', kanji: '勉強する', meaning: 'to study', group: 'irregular', masu: 'べんきょうします', te: 'べんきょうして', ta: 'べんきょうした', nai: 'べんきょうしない', nakatta: 'べんきょうしなかった' },
  { id: 'v-054', dictionary: 'けっこんする', kanji: '結婚する', meaning: 'to get married', group: 'irregular', masu: 'けっこんします', te: 'けっこんして', ta: 'けっこんした', nai: 'けっこんしない', nakatta: 'けっこんしなかった' },
  { id: 'v-055', dictionary: 'りょこうする', kanji: '旅行する', meaning: 'to travel', group: 'irregular', masu: 'りょこうします', te: 'りょこうして', ta: 'りょこうした', nai: 'りょこうしない', nakatta: 'りょこうしなかった' },
]
